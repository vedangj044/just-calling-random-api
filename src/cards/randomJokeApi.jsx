...
const RandomJokeApi = () => {
  ...
  useEffect(() => {
    axios
      .get("https://v2.jokeapi.dev/joke/Programming,Miscellaneous")
      .then((res) => {
  ...
  return (
    <div className="">
      <div className="mx-4 my-11 rounded-md p-4 border-1 shadow-2xl md:px-4">
        <h1 className="text-xl py-2 text-black Bold">Random Joke API</h1>
        ...
        />
        <ApiInfo apiUrl="https://sv443.net/jokeapi/v2/" apiName="Random Joke" />
      </div>
    </div>
  );
};
