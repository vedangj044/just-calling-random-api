...
export default function CryptoDetails(props) {
  ...
  return (
    <div className="mx-4 my-11 rounded-md p-4 border-1 shadow-2xl md:px-4">
      ...
      <ContributorInfo
        username="sejalrai23"
        profilePic="https://avatars.githubusercontent.com/u/62560971?s=400&u=1e003d4cd23d79722f70a6d8b2da4a868e0d9782&v=4"
      />
