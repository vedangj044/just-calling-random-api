    ...
    return( 
        <div className='mx-4 my-11 space-y-6 rounded-md p-4 border-1 shadow-2xl md:px-4'>
            ...
            <div className='aspect-w-1 aspect-h-1'>
                <img className="h-90 w-full px-60 object-cover relative right-3.5" src={dogInfo} alt="dog" />
            </div>
            <div>
                <p className='italic'>Doggo ~ "{animeQuotes}"</p>
            </div>
            <div>
                <button className='bg-green-500 px-4 py-2 text-white rounded-md' onClick={fetchApi}>Get Another</button>
            </div>
