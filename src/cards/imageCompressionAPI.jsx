...
const ImageCompression = () => {
  const [originalUrl, setOriginalUrl] = useState('https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885__480.jpg');
  ...
  return (
    <div>
      <div className='flex mx-4 my-8 rounded-md p-4 border-2 border-grey-300 md:px-4'>
        <div className='w-5/12'>
          ...
          <input
            ...
            value={quality}
            onChange={(e) => setQuality(+e.target.value > 100 ? 100 : +e.target.value < 1 ? 1 : +e.target.value)}
          />
          <button
          ...
          <br />
          <ContributorInfo username='Bihan001' profilePic='https://avatars.githubusercontent.com/Bihan001' />
