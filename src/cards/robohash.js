    ...
    <div className="">
      ...
      <div className='block'>
        <div className='container'>
          <img
            src={`https://robohash.org/${randomId}`} alt='robots'
            className='user-img'
          />
          <p className='user-title'>{DEFAULT_NAME}</p>

          <button className='btn border border-transparent text-sm font-medium rounded-md text-white bg-red-600 
         hover:bg-indigo-700' type='button' onClick={generateRandomIdHandler}>
            New Friend
          </button>
        </div>
      </div>
