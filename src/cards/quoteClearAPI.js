...
const QuoteClearAPI = () => {
    ...
    return (
        <div className="mx-4 my-8 rounded-md p-4 border-2 border-grey-300 md:px-4">
            ...
            <ContributorInfo username="vishalkr058" profilePic="https://avatars.githubusercontent.com/u/22008102?v=4"
            />
            <ApiInfo apiUrl="https://quoteclear.web.app/api/random" apiName="quoteclear"
            />
        </div>
    )
}
