...
export default function Foaas() {
    ...
    return (
        <div className="mx-4 my-8 rounded-md p-4  md:px-4">
            <h1 className="text-xl py-2 text-blue-700 font-bold">STFU as a service</h1>

            <input type="text" name="from" placeholder=" From " className="border-2 border-blue-300 mr-4 py-2"
             value={from} onChange={(e)=>{setFrom(e.target.value)}}
         />&nbsp;&nbsp;&nbsp;&nbsp;
         
         <input type="text" name="to" placeholder=" To " className="border-2 border-blue-300 mr-4 py-2"
