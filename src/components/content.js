        ...
        <div className="grid place-items-center mx-4 my-8">
            <div className="flex flex-col bg-blue-100 rounded-md md:px-16 px-4 max-w-2xl">
                ...
                <div className="flex pb-5">
                    <button className="bg-blue-500 rounded-md p-4 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-opacity-50"><a href="https://github.com/vedangj044/just-calling-random-api" target="blank" >Start Here</a></button>
                </div>
            </div>
        </div>
    );
